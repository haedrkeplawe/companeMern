    ...
    return (
        <div className={product.num_product <= 0 ? "box sale" : "box "}>
            ...
            <div className='price' id={`${mainindex}`}>
                {product.pricebefore && <span className='before'>{"$" + product.pricebefore + ".00"}</span>}
            ...
            <div className='rate'>
                <div className={product.rate > 0 ? "avtive" : ""}>
                    <FontAwesomeIcon icon={faStar} />
                </div>
                <div className={product.rate > 1 ? "avtive" : ""}>
                    <FontAwesomeIcon icon={faStar} />
                </div>
                <div className={product.rate > 2 ? "avtive" : ""}>
                    <FontAwesomeIcon icon={faStar} />
                </div>
                <div className={product.rate > 3 ? "avtive" : ""}>
                    <FontAwesomeIcon icon={faStar} />
                </div>
                <div className={product.rate > 4 ? "avtive" : ""}>
                    <FontAwesomeIcon icon={faStar} />
                </div>
            </div>
        </div>
